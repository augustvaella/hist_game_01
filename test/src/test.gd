...
func _ready():
	...
	Master.resource_server.request_load_resource("res://test/assets/test_resource_0.tres")
	Master.resource_server.request_load_resource("res://test/assets/test_resource_1.tres")
	Master.resource_server.request_load_resource("res://test/assets/test_resource_2.tres")
